...
Rather than hardcoding brand assumptions, implement semantic design tokens:
...
- Deep forest tones
- Warm earth tones
- Sand / off-white backgrounds
- Dark charcoal typography
- Limited high-energy accent color

Final colors should be supplied through brand design or extracted from approved Hike Remote visual assets.
...
- [ ] Newsletter form UI.
- [ ] Corporate enquiry form UI.
- [ ] Mock data or CMS integration.
...
The MVP should be considered ready for handoff when:

1. All primary routes are implemented.
